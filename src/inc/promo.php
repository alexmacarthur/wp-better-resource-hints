...
<div class="PromoBar">
	...
	<ul class="FeedbackList">
		<li class="FeedbackList-item FeedbackItem">
			<a class="FeedbackItem-link FeedbackItem-link--github" href="https://github.com/alexmacarthur/wp-better-resource-hints" target="_blank"><?php echo file_get_contents(plugin_dir_url( __FILE__ ) . '../assets/img/github.svg'); ?></a>
